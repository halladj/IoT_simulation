...
class SimulationConfig:
    ...
    def parse_arguments(self, argv):
        """Parse command line arguments using NS-3 CommandLine"""
        cmd = ns.CommandLine(__file__)
        cmd.AddValue("numFixed", "Number of fixed nodes")
        cmd.AddValue("numMobile", "Number of mobile nodes")
        cmd.AddValue("simTime", "Simulation time in seconds")
        cmd.AddValue("distance", "Distance between fixed nodes")
        cmd.AddValue("pcap", "Enable PCAP tracing")
        cmd.AddValue("verbose", "Enable verbose logging")
        cmd.AddValue("discoveryDuration", "Discovery phase duration")
        cmd.AddValue("collabDuration", "Collaboration phase duration")
        cmd.Parse(argv)
...
class AnimationManager:
    ...
    def setup_animation(self):
        """Configure NetAnim visualization"""
...
class Simulation:
    ...
    def initialize(self, argv):
        ...
        self.anim_manager = AnimationManager(self.config, self.node_manager)
    ...
    def setup(self):
        ...
        # Setup animation
        self.anim_manager.setup_animation()
    ...
    def run(self):
        ...
        print(f"Animation file: discovery-collab-animation.xml")
        print(f"{'='*70}\n")
